...
parser.add_argument("--project_root", default="/home")
...
parser.add_argument("--dataset",type=str, default = "icd_coding")
parser.add_argument("--result_file", type=str, default="./results.txt")
parser.add_argument("--scripts_path", type=str, default="./scripts/")
parser.add_argument("--class_labels_file", type=str, default="../data/labels.txt")
...
if args.tune_plm == True:
    ...
    ckpt_dir = f"{args.project_root}/checkpoints/"
else:
...
if args.dataset == "icd_coding":
    ...
    scriptsbase = f"{args.scripts_path}/"
    scriptformat = "txt"
    max_seq_l = 480
    if args.tune_plm:
...
def plot_confusion_matrix(cm, class_names):
    ...
    figure.savefig(f'/home/sr/Public_Clinical_Prompt-main/mimic-all-tasks/mimic3-icd9-data/test_mtx.png')
